...
<body class="bg-zinc-950 text-zinc-100 min-h-screen flex flex-col justify-between">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('wakasek.dashboard') }}" class="text-2xl font-bold tracking-tight bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">
                ...
                <nav class="hidden md:flex items-center gap-6">
                    <a href="{{ route('wakasek.dashboard') }}" 
                        class="text-sm font-medium transition duration-200 {{ request()->routeIs('wakasek.dashboard') ? 'text-white border-b-2 border-indigo-500 pb-1' : 'text-zinc-400 hover:text-white' }}">
                        Dashboard
                    </a>
                    <a href="{{ route('wakasek.teachers') }}" 
                        class="text-sm font-medium transition duration-200 {{ request()->routeIs('wakasek.teachers*') ? 'text-white border-b-2 border-indigo-500 pb-1' : 'text-zinc-400 hover:text-white' }}">
                        Kelola Guru
                    </a>
                    <a href="{{ route('wakasek.leaves') }}" 
                        class="text-sm font-medium transition duration-200 {{ request()->routeIs('wakasek.leaves*') ? 'text-white border-b-2 border-indigo-500 pb-1' : 'text-zinc-400 hover:text-white' }}">
                        Persetujuan Izin
                    </a>
                    <a href="{{ route('wakasek.reports') }}" 
                        class="text-sm font-medium transition duration-200 {{ request()->routeIs('wakasek.reports*') ? 'text-white border-b-2 border-indigo-500 pb-1' : 'text-zinc-400 hover:text-white' }}">
                        Laporan
                    </a>
                    <a href="{{ route('wakasek.settings') }}" 
                        class="text-sm font-medium transition duration-200 {{ request()->routeIs('wakasek.settings*') ? 'text-white border-b-2 border-indigo-500 pb-1' : 'text-zinc-400 hover:text-white' }}">
                        Pengaturan
                    </a>
                </nav>
    ...
    <div class="md:hidden bg-zinc-900 border-t border-zinc-800 sticky bottom-0 z-50 px-4 py-2 flex justify-around items-center">
        <a href="{{ route('wakasek.dashboard') }}" 
            class="flex flex-col items-center justify-center py-1 transition duration-200 {{ request()->routeIs('wakasek.dashboard') ? 'text-indigo-400' : 'text-zinc-500 hover:text-zinc-300' }}">
        ...
        <a href="{{ route('wakasek.teachers') }}" 
            class="flex flex-col items-center justify-center py-1 transition duration-200 {{ request()->routeIs('wakasek.teachers*') ? 'text-indigo-400' : 'text-zinc-500 hover:text-zinc-300' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.109A2.25 2.25 0 0112.75 21.5h-1.5a2.25 2.25 0 01-2.25-2.263V19.13m4.5 0c.086 0 .172-.007.258-.022M9.252 19.128a9.38 9.38 0 01-2.625.372 9.337 9.337 0 01-4.121-.952 4.125 4.125 0 017.533-2.493M9.252 19.128v-.003c0-1.113.285-2.16.786-3.07M9.252 19.128v.109A2.25 2.25 0 017 21.5h-1.5a2.25 2.25 0 01-2.25-2.263V19.13M12.75 14.25c.086 0 .172-.007.258-.022M9 7.5a3 3 0 116 0 3 3 0 01-6 0zm6 2.25a3 3 0 116 0 3 3 0 01-6 0zm-12 0a3 3 0 116 0 3 3 0 01-6 0z" />
            </svg>
            <span class="text-[9px] mt-1 font-medium">Guru</span>
        </a>
        <a href="{{ route('wakasek.leaves') }}" 
            class="flex flex-col items-center justify-center py-1 transition duration-200 {{ request()->routeIs('wakasek.leaves*') ? 'text-indigo-400' : 'text-zinc-500 hover:text-zinc-300' }}">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
