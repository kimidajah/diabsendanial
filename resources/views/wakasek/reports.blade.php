...
<div class="space-y-6">
    ...
    <div class="bg-zinc-900/40 border border-zinc-800/80 rounded-2xl p-6 hover:border-zinc-700/50 transition duration-300">
        <h3 class="text-lg font-bold text-white mb-4">Filter Rekapitulasi Absensi</h3>
        ...
        <form action="{{ route('wakasek.reports') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
            ...
            <div class="flex gap-2.5">
                ...
                <a href="{{ route('wakasek.reports') }}" 
                    class="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white font-medium text-xs py-3 px-4 rounded-xl transition duration-200 border border-zinc-700 flex justify-center items-center active:scale-95">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="bg-zinc-900/40 border border-zinc-800/80 rounded-2xl p-6 hover:border-zinc-700/50 transition duration-300">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h3 class="text-base font-bold text-white">Data Log Absensi Keseluruhan</h3>
