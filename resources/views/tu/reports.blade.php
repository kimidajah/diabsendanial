...
<div class="space-y-6">
    ...
    <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
        <h3 class="text-lg font-bold text-zinc-100 mb-4">Filter Laporan Absensi</h3>
        ...
        <form action="{{ route('tu.reports') }}" method="GET" class="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
            ...
            <div class="flex gap-2.5">
                ...
                <a href="{{ route('tu.reports') }}" 
                    class="bg-zinc-800 hover:bg-zinc-700 text-zinc-300 font-medium text-xs py-3 px-4 rounded-xl border border-zinc-700 flex justify-center items-center" title="Reset Filter">
                    Reset
                </a>
            </div>
        </form>
    ...
    <div class="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                <h3 class="text-base font-bold text-zinc-100">Data Log Kehadiran</h3>
